              ...
              <div className="flex h-full min-h-0 flex-col overflow-hidden rounded-2xl border-4 border-[#111111] shadow-[6px_6px_0_#111111]">
                ...
                <div className="flex flex-1 min-h-0 bg-[#F6F1E7]">
                  ...
                  <div className="flex flex-[3] min-w-0 flex-col min-h-0 overflow-hidden bg-[#22A3FF] border-r-4 border-[#111111]">
                    ...
                    <div className="flex-1 min-w-0 max-w-full min-h-0 overflow-y-auto overflow-x-hidden px-5 pb-5 slide-content-card proposal-richtext whitespace-normal hyphens-none text-white [&_*]:text-white [&_*]:opacity-100">
                      {summaryText ? (
                        <RichTextViewer
                  ...
                  <div className="flex flex-[2] min-w-0 flex-col min-h-0 gap-4 p-4">
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0 max-w-full overflow-y-auto overflow-x-hidden proposal-richtext whitespace-normal hyphens-none text-sm leading-relaxed text-[#111111] [&_*]:text-[#111111] [&_*]:opacity-100">
