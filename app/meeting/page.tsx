            ...
            {proposal && (proposal.proposal_type || "proposal") !== "admin" ? (
              <div className="flex h-full min-h-0 flex-col gap-4">
                ...
                <div className="grid flex-1 min-h-0 grid-cols-1 items-stretch gap-6 lg:grid-cols-5">
                  <PopCard className="col-span-1 flex min-h-0 min-w-0 flex-col overflow-hidden !bg-[#22A3FF] text-black border-[var(--border)] shadow-[var(--shadow-style)] lg:col-span-3">
                    <div className="mb-2 text-sm uppercase tracking-[0.18em] text-black/90">Details</div>
                    <div className="flex-1 min-h-0 min-w-0 overflow-auto space-y-3 text-sm leading-relaxed opacity-100 text-black slide-content-card [&_*]:opacity-100 [&_*]:text-black">
                      {summaryText ? (
                        <RichTextViewer
                  ...
                  <div className="grid min-h-0 min-w-0 grid-rows-2 gap-6 lg:col-span-2">
                    <PopCard className="relative flex min-h-0 flex-1 flex-col overflow-hidden pt-4 shadow-[6px_6px_0_#FF3B30]" aria-label="Proposal pros">
                      ...
                      <div className="flex-1 min-w-0 overflow-y-auto text-sm leading-relaxed opacity-100 text-black slide-content-card [&_*]:text-black [&_*]:opacity-100">
